 ...
 * @author Lenovo
 */
public class servletSeccionConferencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dtoUsuario == null) {
                ...
                getServletContext().getRequestDispatcher("/conferencia/menu/conferencia/seccionConferencia.jsp").forward(request, response);
            }
